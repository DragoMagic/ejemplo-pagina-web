		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<h3>Completa y Cotiza</h3>
					<form action="Action.php" method="post">
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Nombre</label>
								<input type="text" id="name" name="nombre" required class="form-control" placeholder="Nombre / Apellido *">
							</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="email" name="correo" required class="form-control" placeholder="Correo Electronico *">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Producto</label>
								<input type="text" id="subject" name="producto" required class="form-control" placeholder="Productos para Cotizar *">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea id="message" name="mensaje" required ncols="30" rows="10" class="form-control" placeholder="Cantidad ó Información adicional *"></textarea>
							</div>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						<h3>Contactanos</h3>
						<ul>
							<li class="icon-mail2"><a href="https://www.gmail.com">LoveArtBF@gmail.com</a></li>
							<li class="icon-facebook"><a href="http://Facebook.com">/LoveArtBF</a></li>
							<li class="icon-instagram"><a href="https://www.instagram.com/loveartbf">@LoveArtBF</a></li>
							<li class="icon-calendar"><a href="https://www.matrimonios.cl/recuerdos-matrimonios/loveartbf--e138351">Matrimonios.cl/LoveArtBF</a></li>
						</ul>
					</div>
